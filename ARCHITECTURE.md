...
Pre-generated outputs from Stages 1–4 are saved in [`outputs/`](outputs/):
- `stage1_output.txt` — Direct LLM call with Vietnamese labor law question
- `stage2_output.txt` — Tool-calling demo (statute of limitations query)
- `stage3_output.txt` — ReAct agent loop with multi-step reasoning
- `stage4_output.txt` — Multi-agent parallel dispatch with DeepSeek model
